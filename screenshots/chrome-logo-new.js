...
(async () => {
  ...
  await page.setContent('<body style="margin:0;display:flex;gap:30px;align-items:center;background:#f2efe9;padding:30px"><div style="width:120px;height:120px">'+NEW+'</div><div style="width:48px;height:48px">'+NEW+'</div></body>');
  await page.screenshot({ path: 'chrome-new.png' });
  await browser.close();
})();
