...
const DICT = {
  ...
  spell:    { w:'spell',    ph:'/spel/',        trUk:'період',     trEs:'período',     trFr:'période',     trDe:'Periode',     trPt:'período',     trEn:'spell',      lvl:'B1', cls:'b-blue',   syn:'period · stretch',     def:'A short period of a particular kind of weather or activity.',  ex:'A calm **spell** let the work go on.' },
  bridges:  { w:'bridge',   ph:'/brɪdʒ/',      trUk:'міст',       trEs:'puente',      trFr:'pont',        trDe:'Brücke',      trPt:'ponte',       trEn:'bridge',     lvl:'A2', cls:'b-green',  syn:'span · crossing',      def:'A structure built over a road, river or gap so people can cross.',ex:'Low **bridges** hop from island to island.' },
  island:   { w:'island',   ph:'/ˈaɪ.lənd/',   trUk:'острів',     trEs:'isla',        trFr:'île',         trDe:'Insel',       trPt:'ilha',        trEn:'island',     lvl:'A2', cls:'b-green',  syn:'isle',                 def:'A piece of land surrounded by water.',                        ex:'A scatter of small **islands** lies offshore.' },
  islands:  { w:'island',   ph:'/ˈaɪ.lənd/',   trUk:'острів',     trEs:'isla',        trFr:'île',         trDe:'Insel',       trPt:'ilha',        trEn:'island',     lvl:'A2', cls:'b-green',  syn:'isle',                 def:'A piece of land surrounded by water.',                        ex:'A scatter of small **islands** lies offshore.' },
  storms:   { w:'storm',    ph:'/stɔːm/',       trUk:'шторм',      trEs:'tormenta',    trFr:'tempête',     trDe:'Sturm',       trPt:'tempestade',  trEn:'storm',      lvl:'A2', cls:'b-green',  syn:'tempest · gale',       def:'Very bad weather with strong wind and rain.',                  ex:'Winter **storms** close the road for days.' },
  threads:  { w:'thread',   ph:'/θred/',        trUk:'пролягає',   trEs:'serpentear',  trFr:'serpenter',   trDe:'schlängeln',  trPt:'serpentear',  trEn:'thread',     lvl:'B2', cls:'b-red',    syn:'wind · weave',         def:'To move or pass carefully through a narrow space.',            ex:'The road **threads** between the rocks.' },
  along:    { w:'along',    ph:'/əˈlɒŋ/',       trUk:'уздовж',     trEs:'a lo largo',  trFr:'le long de',  trDe:'entlang',     trPt:'ao longo',    trEn:'along',      lvl:'A2', cls:'b-green',  syn:'beside',               def:'Moving in a line next to something long.',                    ex:'They walked **along** the shore.' },
  stretch:  { w:'stretch',  ph:'/stretʃ/',      trUk:'ділянка',    trEs:'tramo',       trFr:'étendue',     trDe:'Abschnitt',   trPt:'trecho',      trEn:'stretch',    lvl:'B1', cls:'b-blue',   syn:'expanse · span',       def:'A continuous area of land or water.',                         ex:'A wild **stretch** of coast.' },
  norwegian:{ w:'Norwegian',ph:'/nɔːˈwiːdʒən/',trUk:'норвезький', trEs:'noruego',     trFr:'norvégien',   trDe:'norwegisch',  trPt:'norueguês',   trEn:'Norwegian',  lvl:'B1', cls:'b-blue',   syn:'',                     def:'Belonging to Norway.',                                        ex:'The **Norwegian** coast is rugged.' },
  linking:  { w:'link',     ph:'/ˈlɪŋkɪŋ/',    trUk:'зʼєднує',    trEs:'uniendo',     trFr:'reliant',     trDe:'verbindend',  trPt:'ligando',     trEn:'linking',    lvl:'A2', cls:'b-green',  syn:'joining · connecting', def:'Joining two or more things together.',                        ex:'A bridge **linking** the islands.' },
  scatter:  { w:'scatter',  ph:'/ˈskætə/',      trUk:'розсип',     trEs:'dispersión',  trFr:'éparpillement',trDe:'Streuung',   trPt:'dispersão',   trEn:'scatter',    lvl:'B2', cls:'b-red',    syn:'sprinkle · spread',    def:'A small, spread-out number of things.',                       ex:'A **scatter** of islands.' },
  chain:    { w:'chain',    ph:'/tʃeɪn/',       trUk:'низка',      trEs:'cadena',      trFr:'chaîne',      trDe:'Kette',       trPt:'cadeia',      trEn:'chain',      lvl:'A2', cls:'b-green',  syn:'series · string',      def:'A connected series of things.',                               ex:'A **chain** of low bridges.' },
  length:   { w:'length',   ph:'/leŋθ/',        trUk:'довжина',    trEs:'longitud',    trFr:'longueur',    trDe:'Länge',       trPt:'comprimento', trEn:'length',     lvl:'A2', cls:'b-green',  syn:'extent',               def:'How long something is from end to end.',                      ex:'The full **length** of the road.' },
  float:    { w:'float',    ph:'/fləʊt/',       trUk:'ширяти',     trEs:'flotar',      trFr:'flotter',     trDe:'schweben',    trPt:'flutuar',     trEn:'float',      lvl:'A2', cls:'b-green',  syn:'drift · hover',        def:'To rest or move on the surface of water or air.',             ex:'It seems to **float** above the sea.' },
  open:     { w:'open',     ph:'/ˈəʊpən/',      trUk:'відкритий',  trEs:'abierto',     trFr:'ouvert',      trDe:'offen',       trPt:'aberto',      trEn:'open',       lvl:'A1', cls:'b-green',  syn:'clear',                def:'Not closed or covered; wide and free.',                       ex:'The **open** sea stretched out.' },
  sea:      { w:'sea',      ph:'/siː/',         trUk:'море',       trEs:'mar',         trFr:'mer',         trDe:'Meer',        trPt:'mar',         trEn:'sea',        lvl:'A1', cls:'b-green',  syn:'ocean',                def:'The salt water that covers most of the Earth.',               ex:'Above the open **sea**.' },
  road:     { w:'road',     ph:'/rəʊd/',        trUk:'дорога',     trEs:'carretera',   trFr:'route',       trDe:'Straße',      trPt:'estrada',     trEn:'road',       lvl:'A1', cls:'b-green',  syn:'route · way',          def:'A wide path for cars and traffic.',                            ex:'The Atlantic **Road**.' },
  atlantic: { w:'Atlantic', ph:'/ətˈlæntɪk/',   trUk:'Атлантичний',trEs:'Atlántico',   trFr:'Atlantique',  trDe:'Atlantik',    trPt:'Atlântico',   trEn:'Atlantic',   lvl:'B1', cls:'b-blue',   syn:'',                     def:'The ocean between Europe/Africa and the Americas.',           ex:'The **Atlantic** Road.' },

  /* ── Eras Tour article (hero demo) — every tappable word, glossed in all 6 languages ── */
  few:        { w:'few',        ph:'/fjuː/',         trUk:'небагато',     trEs:'pocos',        trFr:'peu de',        trDe:'wenige',       trPt:'poucos',       trEn:'few',        lvl:'A2', cls:'b-green',  syn:'not many',           def:'A small number of.',                                          ex:'**Few** musicians branch out.' },
  musicians:  { w:'musician',   ph:'/mjuːˈzɪʃ.ən/',  trUk:'музиканти',    trEs:'músicos',      trFr:'musiciens',     trDe:'Musiker',      trPt:'músicos',      trEn:'musicians',  lvl:'A2', cls:'b-green',  syn:'players · artists',  def:'People who play or write music.',                             ex:'Few **musicians** cross so many genres.' },
  branch:     { w:'branch out', ph:'/brɑːntʃ/',      trUk:'розгалужуватися',trEs:'diversificarse',trFr:'se diversifier',trDe:'sich verzweigen',trPt:'diversificar-se',trEn:'branch out',lvl:'B2', cls:'b-red',    syn:'diversify · expand', def:'To start doing something new and different.',                 ex:'Musicians who **branch** out widely.' },
  out:        { w:'out',        ph:'/aʊt/',          trUk:'назовні',      trEs:'fuera',        trFr:'dehors',        trDe:'hinaus',       trPt:'fora',         trEn:'out',        lvl:'A1', cls:'b-green',  syn:'outward',            def:'Away from the inside or centre.',                             ex:'branch **out** across genres.' },
  across:     { w:'across',     ph:'/əˈkrɒs/',       trUk:'через',        trEs:'a través de',  trFr:'à travers',     trDe:'über',         trPt:'através de',   trEn:'across',     lvl:'A2', cls:'b-green',  syn:'over · through',     def:'From one side to the other.',                                 ex:'**across** so many genres.' },
  so:         { w:'so',         ph:'/səʊ/',          trUk:'настільки',    trEs:'tan',          trFr:'si',            trDe:'so',           trPt:'tão',          trEn:'so',         lvl:'A1', cls:'b-green',  syn:'such',               def:'To such a great degree.',                                     ex:'**so** many genres.' },
  many:       { w:'many',       ph:'/ˈmen.i/',       trUk:'багато',       trEs:'muchos',       trFr:'beaucoup',      trDe:'viele',        trPt:'muitos',       trEn:'many',       lvl:'A1', cls:'b-green',  syn:'numerous',           def:'A large number of.',                                          ex:'so **many** genre walls.' },
  genre:      { w:'genre',      ph:'/ˈʒɒn.rə/',      trUk:'жанр',         trEs:'género',       trFr:'genre',         trDe:'Genre',        trPt:'gênero',       trEn:'genre',      lvl:'B2', cls:'b-red',    syn:'style · category',   def:'A type or category of art, music or writing.',                ex:'spanning every **genre**.' },
  walls:      { w:'wall',       ph:'/wɔːl/',         trUk:'стіни',        trEs:'muros',        trFr:'murs',          trDe:'Mauern',       trPt:'muros',        trEn:'walls',      lvl:'A1', cls:'b-green',  syn:'barriers',           def:'Upright structures that divide or enclose.',                  ex:'genre **walls** few cross.' },
  and:        { w:'and',        ph:'/ænd/',          trUk:'і',            trEs:'y',            trFr:'et',            trDe:'und',          trPt:'e',            trEn:'and',        lvl:'A1', cls:'b-green',  syn:'plus',               def:'Used to join words or ideas.',                                ex:'walls **and** audiences.' },
  keep:       { w:'keep',       ph:'/kiːp/',         trUk:'утримувати',   trEs:'mantener',     trFr:'garder',        trDe:'behalten',     trPt:'manter',       trEn:'keep',       lvl:'A2', cls:'b-green',  syn:'hold · retain',      def:'To go on having or holding something.',                       ex:'**keep** every audience.' },
  every:      { w:'every',      ph:'/ˈev.ri/',       trUk:'кожен',        trEs:'cada',         trFr:'chaque',        trDe:'jeder',        trPt:'cada',         trEn:'every',      lvl:'A1', cls:'b-green',  syn:'each · all',         def:'Each one of a group, without exception.',                     ex:'**every** audience.' },
  audience:   { w:'audience',   ph:'/ˈɔː.di.əns/',   trUk:'аудиторія',    trEs:'público',      trFr:'public',        trDe:'Publikum',     trPt:'público',      trEn:'audience',   lvl:'B1', cls:'b-blue',   syn:'crowd · listeners',  def:'The people who watch or listen to something.',                ex:'keep every **audience**.' },
  moved:      { w:'move',       ph:'/muːv/',         trUk:'перейшла',     trEs:'pasó',         trFr:'est passée',    trDe:'wechselte',    trPt:'passou',       trEn:'moved',      lvl:'A2', cls:'b-green',  syn:'shifted · went',     def:'To go from one place, state or style to another.',            ex:'**moved** from country to pop.' },
  from:       { w:'from',       ph:'/frɒm/',         trUk:'від',          trEs:'de',           trFr:'de',            trDe:'von',          trPt:'de',           trEn:'from',       lvl:'A1', cls:'b-green',  syn:'out of',             def:'Showing a starting point.',                                   ex:'**from** country to pop.' },
  country:    { w:'country',    ph:'/ˈkʌn.tri/',     trUk:'кантрі',       trEs:'country',      trFr:'country',       trDe:'Country',      trPt:'country',      trEn:'country',    lvl:'B2', cls:'b-red',    syn:'country music',      def:'A style of popular music from the rural US South.',           ex:'from **country** to pop.' },
  to:         { w:'to',         ph:'/tuː/',          trUk:'до',           trEs:'a',            trFr:'à',             trDe:'zu',           trPt:'a',            trEn:'to',         lvl:'A1', cls:'b-green',  syn:'toward',             def:'Showing direction or a limit.',                               ex:'country **to** pop.' },
  pop:        { w:'pop',        ph:'/pɒp/',          trUk:'поп',          trEs:'pop',          trFr:'pop',           trDe:'Pop',          trPt:'pop',          trEn:'pop',        lvl:'A2', cls:'b-green',  syn:'pop music',          def:'Modern popular music with wide appeal.',                      ex:'from country to **pop**.' },
  folk:       { w:'folk',       ph:'/fəʊk/',         trUk:'фолк',         trEs:'folk',         trFr:'folk',          trDe:'Folk',         trPt:'folk',         trEn:'folk',       lvl:'B1', cls:'b-blue',   syn:'folk music',         def:'Traditional-style music of a people or region.',              ex:'to indie **folk**.' },
  without:    { w:'without',    ph:'/wɪˈðaʊt/',      trUk:'без',          trEs:'sin',          trFr:'sans',          trDe:'ohne',         trPt:'sem',          trEn:'without',    lvl:'A2', cls:'b-green',  syn:'lacking',            def:'Not having or not using something.',                          ex:'**without** losing her fans.' },
  losing:     { w:'lose',       ph:'/luːz/',         trUk:'втрачати',     trEs:'perder',       trFr:'perdre',        trDe:'verlieren',    trPt:'perder',       trEn:'losing',     lvl:'A2', cls:'b-green',  syn:'shedding',           def:'To stop having something or someone.',                        ex:'**without losing** her fans.' },
  her:        { w:'her',        ph:'/hɜː/',          trUk:'її',           trEs:'su',           trFr:'sa',            trDe:'ihr',          trPt:'sua',          trEn:'her',        lvl:'A1', cls:'b-green',  syn:'hers',               def:'Belonging to a female already mentioned.',                    ex:'**her** devoted fans.' },
  devoted:    { w:'devoted',    ph:'/dɪˈvəʊ.tɪd/',   trUk:'відданий',     trEs:'devoto',       trFr:'dévoué',        trDe:'treu',         trPt:'devotado',     trEn:'devoted',    lvl:'B2', cls:'b-green',  syn:'loyal · dedicated',  def:'Very loving and loyal.',                                      ex:'her **devoted** fans.' },
  fans:       { w:'fan',        ph:'/fæn/',          trUk:'фанати',       trEs:'fans',         trFr:'fans',          trDe:'Fans',         trPt:'fãs',          trEn:'fans',       lvl:'A2', cls:'b-green',  syn:'admirers · followers',def:'People who strongly admire someone or something.',           ex:'her devoted **fans**.' },
  cultural:   { w:'cultural',   ph:'/ˈkʌl.tʃər.əl/', trUk:'культурний',   trEs:'cultural',     trFr:'culturel',      trDe:'kulturell',    trPt:'cultural',     trEn:'cultural',   lvl:'B2', cls:'b-red',    syn:'social · artistic',  def:'Relating to the arts and ways of life of a society.',         ex:'a **cultural** phenomenon.' },
  phenomenon: { w:'phenomenon', ph:'/fɪˈnɒm.ɪ.nən/',trUk:'явище',        trEs:'fenómeno',     trFr:'phénomène',     trDe:'Phänomen',     trPt:'fenômeno',     trEn:'phenomenon', lvl:'B2', cls:'b-red',    syn:'marvel · wonder',    def:'A remarkable thing, person or event.',                        ex:'a cultural **phenomenon**.' },
  who:        { w:'who',        ph:'/huː/',          trUk:'який',         trEs:'que',          trFr:'qui',           trDe:'der',          trPt:'que',          trEn:'who',        lvl:'A1', cls:'b-green',  syn:'that',               def:'Used to refer to a person already mentioned.',                ex:'a phenomenon **who** left a legacy.' },
  left:       { w:'leave',      ph:'/liːv/',         trUk:'залишив',      trEs:'dejó',         trFr:'a laissé',      trDe:'hinterließ',   trPt:'deixou',       trEn:'left',       lvl:'A2', cls:'b-green',  syn:'handed down',        def:'To cause something to remain after going or ending.',         ex:'**left** a legacy.' },
  legacy:     { w:'legacy',     ph:'/ˈleɡ.ə.si/',    trUk:'спадщина',     trEs:'legado',       trFr:'héritage',      trDe:'Erbe',         trPt:'legado',       trEn:'legacy',     lvl:'C1', cls:'b-violet', syn:'heritage · inheritance',def:'Something handed down from the past or a person.',          ex:'a **legacy** no one predicted.' },
  no:         { w:'no',         ph:'/nəʊ/',          trUk:'жоден',        trEs:'ningún',       trFr:'aucun',         trDe:'kein',         trPt:'nenhum',       trEn:'no',         lvl:'A1', cls:'b-green',  syn:'not any',            def:'Not any; not one.',                                           ex:'**no** one had predicted.' },
  one:        { w:'one',        ph:'/wʌn/',          trUk:'один',         trEs:'uno',          trFr:'un',            trDe:'eins',         trPt:'um',           trEn:'one',        lvl:'A1', cls:'b-green',  syn:'(no one = nobody)',  def:'The number 1; here part of "no one" — not a single person.',  ex:'no **one** had predicted.' },
  had:        { w:'have',       ph:'/hæd/',          trUk:'мав',          trEs:'había',        trFr:'avait',         trDe:'hatte',        trPt:'tinha',        trEn:'had',        lvl:'A1', cls:'b-green',  syn:'(past of have)',     def:'Past form of "have"; used to build past tenses.',             ex:'no one **had** predicted.' },
  predicted:  { w:'predict',    ph:'/prɪˈdɪkt/',     trUk:'передбачив',   trEs:'predijo',      trFr:'a prédit',      trDe:'vorhergesagt', trPt:'previu',       trEn:'predicted',  lvl:'B2', cls:'b-red',    syn:'foresaw · forecast', def:'To say what will happen before it does.',                     ex:'a legacy no one had **predicted**.' },
  commercial: { w:'commercial', ph:'/kəˈmɜː.ʃəl/',   trUk:'комерційний',  trEs:'comercial',    trFr:'commercial',    trDe:'kommerziell',  trPt:'comercial',    trEn:'commercial', lvl:'B2', cls:'b-red',    syn:'market · trade',     def:'Relating to buying, selling and making money.',               ex:'her **commercial** dominance.' },
  dominance:  { w:'dominance',  ph:'/ˈdɒm.ɪ.nəns/',  trUk:'домінування',  trEs:'dominio',      trFr:'domination',    trDe:'Dominanz',     trPt:'domínio',      trEn:'dominance',  lvl:'C1', cls:'b-violet', syn:'supremacy · control',def:'Power, success or influence over all others.',                ex:'her commercial **dominance**.' },
  spanning:   { w:'span',       ph:'/spæn/',         trUk:'охоплюючи',    trEs:'abarcando',    trFr:'couvrant',      trDe:'umfassend',    trPt:'abrangendo',   trEn:'spanning',   lvl:'B2', cls:'b-red',    syn:'covering · crossing',def:'To extend across or include a whole range.',                  ex:'**spanning** every genre.' },
  has:        { w:'have',       ph:'/hæz/',          trUk:'має',          trEs:'ha',           trFr:'a',             trDe:'hat',          trPt:'tem',          trEn:'has',        lvl:'A1', cls:'b-green',  syn:'(3rd person of have)',def:'Form of "have"; used to build the present perfect.',         ex:'**has** left critics asking.' },
  critics:    { w:'critic',     ph:'/ˈkrɪt.ɪk/',     trUk:'критики',      trEs:'críticos',     trFr:'critiques',     trDe:'Kritiker',     trPt:'críticos',     trEn:'critics',    lvl:'B1', cls:'b-blue',   syn:'reviewers',          def:'People who judge books, music, art and so on.',               ex:'has left **critics** asking.' },
  asking:     { w:'ask',        ph:'/ɑːsk/',         trUk:'запитувати',   trEs:'preguntar',    trFr:'demander',      trDe:'fragen',       trPt:'perguntar',    trEn:'asking',     lvl:'A1', cls:'b-green',  syn:'wondering',          def:'To put a question; to want to know.',                         ex:'critics **asking** whether.' },
  whether:    { w:'whether',    ph:'/ˈweð.ər/',      trUk:'чи',           trEs:'si',           trFr:'si',            trDe:'ob',           trPt:'se',           trEn:'whether',    lvl:'B1', cls:'b-blue',   syn:'if',                 def:'Used to introduce a choice between possibilities.',           ex:'asking **whether** it can.' },
  "today's":  { w:"today's",    ph:'/təˈdeɪz/',      trUk:'сьогоднішня',  trEs:'de hoy',       trFr:"d'aujourd'hui", trDe:'heutige',      trPt:'de hoje',      trEn:"today's",    lvl:'A2', cls:'b-green',  syn:'present-day',        def:'Belonging to the present day.',                               ex:"**today's** music industry." },
  music:      { w:'music',      ph:'/ˈmjuː.zɪk/',    trUk:'музика',       trEs:'música',       trFr:'musique',       trDe:'Musik',        trPt:'música',       trEn:'music',      lvl:'A1', cls:'b-green',  syn:'songs',              def:'Sounds arranged to be pleasing or expressive.',               ex:'the **music** industry.' },
  industry:   { w:'industry',   ph:'/ˈɪn.də.stri/',  trUk:'індустрія',    trEs:'industria',    trFr:'industrie',     trDe:'Branche',      trPt:'indústria',    trEn:'industry',   lvl:'B1', cls:'b-blue',   syn:'business · sector',  def:'A branch of business making or providing something.',         ex:"today's music **industry**." },
  can:        { w:'can',        ph:'/kæn/',          trUk:'може',         trEs:'puede',        trFr:'peut',          trDe:'kann',         trPt:'pode',         trEn:'can',        lvl:'A1', cls:'b-green',  syn:'is able to',         def:'To be able to do something.',                                 ex:'**can** accommodate it.' },
  accommodate:{ w:'accommodate',ph:'/əˈkɒm.ə.deɪt/', trUk:'вмістити',     trEs:'dar cabida',   trFr:'accueillir',    trDe:'aufnehmen',    trPt:'acomodar',     trEn:'accommodate',lvl:'C1', cls:'b-violet', syn:'hold · fit',         def:'To have room for, or make space for.',                        ex:'**accommodate** a phenomenon.' },
  of:         { w:'of',         ph:'/əv/',           trUk:'з',            trEs:'de',           trFr:'de',            trDe:'von',          trPt:'de',           trEn:'of',         lvl:'A1', cls:'b-green',  syn:'belonging to',       def:'Showing belonging or connection.',                            ex:'a phenomenon **of** her scale.' },
  scale:      { w:'scale',      ph:'/skeɪl/',        trUk:'масштаб',      trEs:'magnitud',     trFr:'ampleur',       trDe:'Ausmaß',       trPt:'escala',       trEn:'scale',      lvl:'B2', cls:'b-red',    syn:'size · magnitude',   def:'The overall size or extent of something.',                    ex:'a phenomenon of her **scale**.' },
  indie:      { w:'indie',      ph:'/ˈɪn.di/',       trUk:'інді',         trEs:'indie',        trFr:'indé',          trDe:'Indie',        trPt:'indie',        trEn:'indie',      lvl:'B2', cls:'b-red',    syn:'independent',        def:'Music made outside the major commercial labels.',             ex:'to **indie** folk.' },
};
// backwards-compat: expose .tr as Ukrainian for deck cards that read d.tr
Object.values(DICT).forEach(function(d){ d.tr = d.trUk; });
